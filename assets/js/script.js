...
var displayPokemon = function (pokemon, i) {
  ...
  pokePicEl.srcset =
    "https://pokeres.bastionbot.org/images/pokemon/" + pokeNumber + ".png";
...
var getCity = function (city) {
  var apiUrl =
    "http://dataservice.accuweather.com/locations/v1/search?apikey=8phV97GIATzlpDJK66fxWSKyzLgvNucC&q=" +
    city +
    "&language=en-ca&details=false";
...
var getWeather = function (cityKey) {
  var apiUrl =
    ...
    cityKey +
    "?apikey=8phV97GIATzlpDJK66fxWSKyzLgvNucC&metric=true";
...
var displayWeather = function (data) {
  ...
  if (
    ...
    iconPhrase === "MOSTLY CLOUDY W/ FLURRIES" ||
    iconPhrase === "MOSYLY CLOUDY W/ SNOW"
  ) {
    getType("fairy");
    getType("fighting");
    getType("poison");
